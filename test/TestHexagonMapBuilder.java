...
public class TestHexagonMapBuilder {
    ...
    @Test
    public void addColumnOdd(){
        UserConfiguration.rowsOfTheMap=2;
        UserConfiguration.columnsOfTheMap=2;
        testMap= new MapBuilder(testList,null);
        testMap.addNewColumn(1);
        Assert.assertEquals(5,testList.size());
    }

    @Test
    public void addColumnEven(){
        UserConfiguration.rowsOfTheMap=2;
        UserConfiguration.columnsOfTheMap=3;
        testMap= new MapBuilder(testList,null);
